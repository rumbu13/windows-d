...
@DllImport("UIAutomationCore")
HRESULT ValuePattern_SetValue(HUIAPATTERNOBJECT__* hobj, const(PWSTR) pVal);
...
///    
@DllImport("UIAutomationCore")
HRESULT WindowPattern_WaitForInputIdle(HUIAPATTERNOBJECT__* hobj, int milliseconds, BOOL* pResult);
...
@DllImport("UIAutomationCore")
HRESULT TextRange_Compare(HUIATEXTRANGE__* hobj, HUIATEXTRANGE__* range, BOOL* pRetVal);
...
@DllImport("UIAutomationCore")
HRESULT LegacyIAccessiblePattern_SetValue(HUIAPATTERNOBJECT__* hobj, const(PWSTR) szValue);
...
///    
@DllImport("USER32")
HWINEVENTHOOK SetWinEventHook(uint eventMin, uint eventMax, ptrdiff_t hmodWinEventProc, 
...
interface IUIAutomationTextRange3 : IUIAutomationTextRange2
{
    ...
    ///    Returns <b>S_OK</b> if successful, otherwise an <b>HRESULT</b> error code.
    ///    
    HRESULT GetAttributeValues(const(int)* attributeIds, int attributeIdCount, SAFEARRAY** attributeValues);
}
...
interface IUIAutomationEventHandlerGroup : IUnknown
{
    ...
    HRESULT AddPropertyChangedEventHandler(TreeScope scope_, IUIAutomationCacheRequest cacheRequest, 
                                           IUIAutomationPropertyChangedEventHandler handler, int* propertyArray, 
                                           int propertyCount);
...
interface IUIAutomation : IUnknown
{
    ...
    HRESULT AddPropertyChangedEventHandlerNativeArray(IUIAutomationElement element, TreeScope scope_, 
                                                      ...
                                                      int* propertyArray, int propertyCount);
