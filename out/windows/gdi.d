...
public import windows.menusandresources : DestroyCursor, DestroyIcon;
...
public import windows.windowscolorsystem : CIEXYZTRIPLE, DeleteColorSpace, LOGCOLORSPACEA,
                                           LOGCOLORSPACEW;
...
alias LPFNDEVMODE = uint function(HWND param0, ptrdiff_t param1, DEVMODEA* param2, PSTR param3, PSTR param4, 
...
///    
@DllImport("USER32")
int DrawTextA(HDC hdc, const(PSTR) lpchText, int cchText, RECT* lprc, uint format);
...
///    
@DllImport("USER32")
int DrawTextW(HDC hdc, const(PWSTR) lpchText, int cchText, RECT* lprc, uint format);
...
///    
@DllImport("USER32")
int DrawTextExA(HDC hdc, PSTR lpchText, int cchText, RECT* lprc, uint format, DRAWTEXTPARAMS* lpdtp);
...
///    
@DllImport("USER32")
int DrawTextExW(HDC hdc, PWSTR lpchText, int cchText, RECT* lprc, uint format, DRAWTEXTPARAMS* lpdtp);
...
///    
@DllImport("USER32")
int ChangeDisplaySettingsExA(const(PSTR) lpszDeviceName, DEVMODEA* lpDevMode, HWND hwnd, uint dwflags, 
                             void* lParam);
...
///    
@DllImport("USER32")
int ChangeDisplaySettingsExW(const(PWSTR) lpszDeviceName, DEVMODEW* lpDevMode, HWND hwnd, uint dwflags, 
                             void* lParam);
...
///    
@DllImport("USER32")
BOOL EnumDisplaySettingsA(const(PSTR) lpszDeviceName, uint iModeNum, DEVMODEA* lpDevMode);
...
///    
@DllImport("USER32")
BOOL EnumDisplaySettingsW(const(PWSTR) lpszDeviceName, uint iModeNum, DEVMODEW* lpDevMode);
...
///    
@DllImport("USER32")
BOOL EnumDisplaySettingsExA(const(PSTR) lpszDeviceName, uint iModeNum, DEVMODEA* lpDevMode, uint dwFlags);
...
///    
@DllImport("USER32")
BOOL EnumDisplaySettingsExW(const(PWSTR) lpszDeviceName, uint iModeNum, DEVMODEW* lpDevMode, uint dwFlags);
...
///    
@DllImport("USER32")
HMONITOR MonitorFromPoint(POINT pt, uint dwFlags);
...
///    
@DllImport("USER32")
HMONITOR MonitorFromRect(RECT* lprc, uint dwFlags);
...
///    
@DllImport("USER32")
HMONITOR MonitorFromWindow(HWND hwnd, uint dwFlags);
...
///    
@DllImport("GDI32")
int CombineRgn(HRGN hrgnDst, HRGN hrgnSrc1, HRGN hrgnSrc2, RGN_COMBINE_MODE iMode);
...
HFONT CreateFontA(int cHeight, int cWidth, int cEscapement, int cOrientation, int cWeight, uint bItalic, 
                  ...
                  uint iQuality, uint iPitchAndFamily, const(PSTR) pszFaceName);
...
HFONT CreateFontW(int cHeight, int cWidth, int cEscapement, int cOrientation, int cWeight, uint bItalic, 
                  uint bUnderline, uint bStrikeOut, uint iCharSet, uint iOutPrecision, uint iClipPrecision, 
                  uint iQuality, uint iPitchAndFamily, const(PWSTR) pszFaceName);
...
///    
@DllImport("GDI32")
HdcMetdataFileHandle CreateMetaFileA(const(PSTR) pszFile);
...
///    
@DllImport("GDI32")
HdcMetdataFileHandle CreateMetaFileW(const(PWSTR) pszFile);
...
///    
@DllImport("GDI32")
int DrawEscape(HDC hdc, int iEscape, int cjIn, const(PSTR) lpIn);
...
///    
@DllImport("GDI32")
ptrdiff_t GetCurrentObject(HDC hdc, OBJ_TYPE type);
...
///    
@DllImport("GDI32")
uint GetGlyphOutlineA(HDC hdc, uint uChar, uint fuFormat, GLYPHMETRICS* lpgm, uint cjBuffer, void* pvBuffer, 
                      const(MAT2)* lpmat2);
...
///    
@DllImport("GDI32")
uint GetGlyphOutlineW(HDC hdc, uint uChar, uint fuFormat, GLYPHMETRICS* lpgm, uint cjBuffer, void* pvBuffer, 
                      const(MAT2)* lpmat2);
...
///    
@DllImport("GDI32")
int AddFontResourceExA(const(PSTR) name, uint fl, void* res);
...
///    
@DllImport("GDI32")
int AddFontResourceExW(const(PWSTR) name, uint fl, void* res);
...
///    
@DllImport("GDI32")
BOOL RemoveFontResourceExA(const(PSTR) name, uint fl, void* pdv);
...
///    
@DllImport("GDI32")
BOOL RemoveFontResourceExW(const(PWSTR) name, uint fl, void* pdv);
...
///    
@DllImport("MSIMG32")
BOOL GradientFill(HDC hdc, TRIVERTEX* pVertex, uint nVertex, void* pMesh, uint nMesh, uint ulMode);
...
///    
@DllImport("GDI32")
BOOL GdiGradientFill(HDC hdc, TRIVERTEX* pVertex, uint nVertex, void* pMesh, uint nCount, uint ulMode);
...
///    
@DllImport("GDI32")
HdcMetdataEnhFileHandle CreateEnhMetaFileA(HDC hdc, const(PSTR) lpFilename, const(RECT)* lprc, const(PSTR) lpDesc);
...
///    
@DllImport("GDI32")
HdcMetdataEnhFileHandle CreateEnhMetaFileW(HDC hdc, const(PWSTR) lpFilename, const(RECT)* lprc, 
                                           const(PWSTR) lpDesc);
...
///    
@DllImport("GDI32")
BOOL ExtTextOutW(HDC hdc, int x, int y, uint options, const(RECT)* lprect, const(PWSTR) lpString, uint c, 
                 const(int)* lpDx);
...
///    
@DllImport("t2embed")
int TTEmbedFontFromFileA(HDC hDC, const(PSTR) szFontFileName, ushort usTTCIndex, uint ulFlags, uint ulCharSet, 
...
int TTEmbedFontEx(HDC hDC, uint ulFlags, uint ulCharSet, uint* pulPrivStatus, uint* pulStatus, 
                  WRITEEMBEDPROC lpfnWriteToStream, void* lpvWriteStream, uint* pulCharCodeSet, 
                  ushort usCharCodeCount, ushort usLanguage, TTEMBEDINFO* pTTEmbedInfo);
